...
const fanArtProducts: Product[] = [
	{
		...
		images: [
			{
				src: '/images/events/af-plus/Fan Art/Cardcaptor Sakura Wooden NFC Keychain.webp',
	...
	},
	{
		...
		images: [
			{
				src: '/images/events/af-plus/Fan Art/Frieren Interactive Keychain.webp',
	...
	},
	{
		...
		images: [
			{
				src: '/images/events/af-plus/Fan Art/Digimon Standee.png',
							...
							<div className="flex flex-col gap-4">
								...
								<div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
									<div className="rounded-xl border border-brown/15 bg-white/60 px-4 py-3">
										...
										<p className="font-rye text-dark-brown text-lg">19 to 20 Dec 2026</p>
									</div>
									<div className="rounded-xl border border-brown/15 bg-white/60 px-4 py-3">
										<p className="font-play text-xs uppercase tracking-widest text-brown/50">Venue</p>
										<p className="font-rye text-dark-brown text-lg">Kuala Lumpur Convention Center</p>
									</div>
								</div>

								<div className="flex flex-wrap gap-3 pt-2">
									<a
										href="https://maps.app.goo.gl/8bfFeyPxrvynRn7k8"
										target="_blank"
              ...
              <ProductCard key={product.name} product={product} />
				...
				<div className="lg:container lg:mx-auto px-8 py-14">
					<div className="rounded-2xl border border-brown/10 bg-white/70 p-8 md:p-10 text-center flex flex-col gap-4 items-center">
						<h2 className="font-rye text-2xl md:text-3xl text-dark-brown">See You At Comic Fiesta 2026</h2>
						<p className="font-play text-brown/70 max-w-2xl">
							All artworks shown on this page are planned for Comic Fiesta 2026.
